...
public class NetworkArchitecturePackageImpl extends EPackageImpl implements NetworkArchitecturePackage {
	...
	public void initializePackageContents() {
		...
		accessPointEClass.getESuperTypes().add(this.getInternalIpAddressElement());
		accessPointEClass.getESuperTypes().add(this.getNamedElement());
		accessPointEClass.getESuperTypes().add(this.getFirmwareElement());
		accessPointEClass.getESuperTypes().add(this.getPortNumberElement());
