...
public class SwitchL3Impl extends InternalIpAddressElementImpl implements SwitchL3 {
	...
	public EList<AccessPoint> getAccessPoints() {
		if (accessPoints == null) {
			accessPoints = new EObjectContainmentEList<AccessPoint>(AccessPoint.class, this, NetworkArchitecturePackage.SWITCH_L3__ACCESS_POINTS);
		}
		return accessPoints;
	}
	...
	public int getTotalConnectedDevices() {
		...
		final /*@NonInvalid*/ List<AccessPoint> accessPoints = this.getAccessPoints();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == PortNumberElement.class) {
			switch (baseOperationID) {
				...
				case NetworkArchitecturePackage.PORT_NUMBER_ELEMENT___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP: return NetworkArchitecturePackage.SWITCH_L3___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case NetworkArchitecturePackage.SWITCH_L3___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP:
