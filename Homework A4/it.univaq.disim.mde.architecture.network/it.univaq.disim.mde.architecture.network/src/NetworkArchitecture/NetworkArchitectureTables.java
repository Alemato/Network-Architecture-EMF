...
public class NetworkArchitectureTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_AccessPoint = NetworkArchitectureTables.PACKid_https_c_s_s_it_univaq_disim_mde_s_NA.getClassId("AccessPoint", 0);
	...
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_AccessPoint = TypeId.BAG.getSpecializedId(NetworkArchitectureTables.CLSSid_AccessPoint, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_AccessPoint = TypeId.SET.getSpecializedId(NetworkArchitectureTables.CLSSid_AccessPoint, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Types {
		...
		public static final EcoreExecutorType _AccessPoint = new EcoreExecutorType(NetworkArchitecturePackage.Literals.ACCESS_POINT, PACKAGE, 0);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _AccessPoint__AccessPoint = new ExecutorFragment(Types._AccessPoint, NetworkArchitectureTables.Types._AccessPoint);
		private static final ExecutorFragment _AccessPoint__FirmwareElement = new ExecutorFragment(Types._AccessPoint, NetworkArchitectureTables.Types._FirmwareElement);
		private static final ExecutorFragment _AccessPoint__InternalIpAddressElement = new ExecutorFragment(Types._AccessPoint, NetworkArchitectureTables.Types._InternalIpAddressElement);
		private static final ExecutorFragment _AccessPoint__NamedElement = new ExecutorFragment(Types._AccessPoint, NetworkArchitectureTables.Types._NamedElement);
		private static final ExecutorFragment _AccessPoint__OclAny = new ExecutorFragment(Types._AccessPoint, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _AccessPoint__OclElement = new ExecutorFragment(Types._AccessPoint, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _AccessPoint__PortNumberElement = new ExecutorFragment(Types._AccessPoint, NetworkArchitectureTables.Types._PortNumberElement);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _AccessPoint__maxClientSupport = new EcoreExecutorProperty(NetworkArchitecturePackage.Literals.ACCESS_POINT__MAX_CLIENT_SUPPORT, Types._AccessPoint, 0);
		public static final ExecutorProperty _AccessPoint__vlan = new EcoreExecutorProperty(NetworkArchitecturePackage.Literals.ACCESS_POINT__VLAN, Types._AccessPoint, 1);
		public static final ExecutorProperty _AccessPoint__wifis = new EcoreExecutorProperty(NetworkArchitecturePackage.Literals.ACCESS_POINT__WIFIS, Types._AccessPoint, 2);
		public static final ExecutorProperty _AccessPoint__SwitchL3__accessPoints = new ExecutorPropertyWithImplementation("SwitchL3", Types._AccessPoint, 3, new EcoreLibraryOppositeProperty(NetworkArchitecturePackage.Literals.SWITCH_L3__ACCESS_POINTS));
		...
		public static final ExecutorProperty _VLAN__AccessPoint__vlan = new ExecutorPropertyWithImplementation("AccessPoint", Types._VLAN, 6, new EcoreLibraryOppositeProperty(NetworkArchitecturePackage.Literals.ACCESS_POINT__VLAN));
		...
		public static final ExecutorProperty _Wifi__AccessPoint__wifis = new ExecutorPropertyWithImplementation("AccessPoint", Types._Wifi, 6, new EcoreLibraryOppositeProperty(NetworkArchitecturePackage.Literals.ACCESS_POINT__WIFIS));
	...
	public static class TypeFragments {
		...
		private static final ExecutorFragment /*@NonNull*/ [] _AccessPoint =
			{
				Fragments._AccessPoint__OclAny /* 0 */,
				Fragments._AccessPoint__OclElement /* 1 */,
				Fragments._AccessPoint__FirmwareElement /* 2 */,
				Fragments._AccessPoint__InternalIpAddressElement /* 2 */,
				Fragments._AccessPoint__NamedElement /* 2 */,
				Fragments._AccessPoint__PortNumberElement /* 2 */,
				Fragments._AccessPoint__AccessPoint /* 3 */
			};
		private static final int /*@NonNull*/ [] __AccessPoint = { 1,1,4,1 };
		 ...
		 */
		static {
			Types._AccessPoint.initFragments(_AccessPoint, __AccessPoint);
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__AccessPoint = {};
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__FirmwareElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__InternalIpAddressElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__OclAny = {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__OclElement = {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _AccessPoint__PortNumberElement = {
		 ...
		 */
		static {
			Fragments._AccessPoint__AccessPoint.initOperations(_AccessPoint__AccessPoint);
			Fragments._AccessPoint__FirmwareElement.initOperations(_AccessPoint__FirmwareElement);
			Fragments._AccessPoint__InternalIpAddressElement.initOperations(_AccessPoint__InternalIpAddressElement);
			Fragments._AccessPoint__NamedElement.initOperations(_AccessPoint__NamedElement);
			Fragments._AccessPoint__OclAny.initOperations(_AccessPoint__OclAny);
			Fragments._AccessPoint__OclElement.initOperations(_AccessPoint__OclElement);
			Fragments._AccessPoint__PortNumberElement.initOperations(_AccessPoint__PortNumberElement);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _AccessPoint = {
			NetworkArchitectureTables.Properties._InternalIpAddressElement__internalIpAddress,
			NetworkArchitectureTables.Properties._AccessPoint__maxClientSupport,
			...
			NetworkArchitectureTables.Properties._AccessPoint__vlan,
			NetworkArchitectureTables.Properties._AccessPoint__wifis
		};
		 ...
		 */
		static {
			Fragments._AccessPoint__AccessPoint.initProperties(_AccessPoint);
