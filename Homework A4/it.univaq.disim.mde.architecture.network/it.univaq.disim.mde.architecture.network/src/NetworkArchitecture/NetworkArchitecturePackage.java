...
public interface NetworkArchitecturePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link NetworkArchitecture.impl.AccessPointImpl <em>Access Point</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see NetworkArchitecture.impl.AccessPointImpl
	 * @see NetworkArchitecture.impl.NetworkArchitecturePackageImpl#getAccessPoint()
	 * @generated
	 */
	int ACCESS_POINT = 8;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__INTERNAL_IP_ADDRESS = INTERNAL_IP_ADDRESS_ELEMENT__INTERNAL_IP_ADDRESS;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__NAME = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__MODEL = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__OS_VERSION = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__OPERATING_SYSTEM = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__PORT_NUMBER = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__MAX_CLIENT_SUPPORT = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__WIFIS = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT__VLAN = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT_FEATURE_COUNT = INTERNAL_IP_ADDRESS_ELEMENT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT___VALID_INTERNAL_IP_ADDRESS__DIAGNOSTICCHAIN_MAP = INTERNAL_IP_ADDRESS_ELEMENT___VALID_INTERNAL_IP_ADDRESS__DIAGNOSTICCHAIN_MAP;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT___IS_VALID_LAN_PORT_NUMBER = INTERNAL_IP_ADDRESS_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP = INTERNAL_IP_ADDRESS_ELEMENT_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACCESS_POINT_OPERATION_COUNT = INTERNAL_IP_ADDRESS_ELEMENT_OPERATION_COUNT + 2;
	...
	/**
	 * Returns the meta object for class '{@link NetworkArchitecture.AccessPoint <em>Access Point</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Access Point</em>'.
	 * @see NetworkArchitecture.AccessPoint
	 * @generated
	 */
	EClass getAccessPoint();

	/**
	 * Returns the meta object for the attribute '{@link NetworkArchitecture.AccessPoint#getMaxClientSupport <em>Max Client Support</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Max Client Support</em>'.
	 * @see NetworkArchitecture.AccessPoint#getMaxClientSupport()
	 * @see #getAccessPoint()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link NetworkArchitecture.AccessPoint#getWifis <em>Wifis</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Wifis</em>'.
	 * @see NetworkArchitecture.AccessPoint#getWifis()
	 * @see #getAccessPoint()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link NetworkArchitecture.AccessPoint#getVlan <em>Vlan</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Vlan</em>'.
	 * @see NetworkArchitecture.AccessPoint#getVlan()
	 * @see #getAccessPoint()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link NetworkArchitecture.impl.AccessPointImpl <em>Access Point</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see NetworkArchitecture.impl.AccessPointImpl
		 * @see NetworkArchitecture.impl.NetworkArchitecturePackageImpl#getAccessPoint()
