...
/**
 * This is the item provider adapter for a {@link NetworkArchitectureLite.Router} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RouterItemProvider extends NetworkDeviceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkArchitectureLitePackage.Literals.ROUTER__ROUTING_PROTOCOL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkArchitectureLitePackage.Literals.ROUTER__VLANS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkArchitectureLitePackage.Literals.ROUTER__SWITCH_L3);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkArchitectureLitePackage.Literals.ROUTER__SWITCH_L3,
				 NetworkArchitectureLiteFactory.eINSTANCE.createSwitchL3()));
	}
