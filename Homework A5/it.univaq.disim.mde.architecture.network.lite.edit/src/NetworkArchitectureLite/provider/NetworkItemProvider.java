...
/**
 * This is the item provider adapter for a {@link NetworkArchitectureLite.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkArchitectureLitePackage.Literals.NETWORK__PUBLIC_IP_ADDRES,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkArchitectureLitePackage.Literals.NETWORK__VLANS);
			childrenFeatures.add(NetworkArchitectureLitePackage.Literals.NETWORK__GATEWAY);
			childrenFeatures.add(NetworkArchitectureLitePackage.Literals.NETWORK__WIFIS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkArchitectureLitePackage.Literals.NETWORK__VLANS,
				 NetworkArchitectureLiteFactory.eINSTANCE.createVLAN()));

		newChildDescriptors.add
			(createChildParameter
				(NetworkArchitectureLitePackage.Literals.NETWORK__GATEWAY,
				 NetworkArchitectureLiteFactory.eINSTANCE.createGateway()));

		newChildDescriptors.add
			(createChildParameter
				(NetworkArchitectureLitePackage.Literals.NETWORK__WIFIS,
				 NetworkArchitectureLiteFactory.eINSTANCE.createWifi()));
	}
