...
/**
 * This is the item provider adapter for a {@link NetworkArchitectureLite.SwitchL2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SwitchL2ItemProvider extends NetworkDeviceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkArchitectureLitePackage.Literals.SWITCH_L2__PORT_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkArchitectureLitePackage.Literals.SWITCH_L2__VLANS,
				 true,
				 false,
				 true,
				 null,
