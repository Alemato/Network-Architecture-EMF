...
public class NetworkArchitectureItemProviderAdapterFactory extends NetworkArchitectureAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link NetworkArchitecture.AcccessPoint} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected AcccessPointItemProvider acccessPointItemProvider;

	/**
	 * This creates an adapter for a {@link NetworkArchitecture.AcccessPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createAcccessPointAdapter() {
		if (acccessPointItemProvider == null) {
			acccessPointItemProvider = new AcccessPointItemProvider(this);
		}

		return acccessPointItemProvider;
	}
	...
	public void dispose() {
		...
		if (acccessPointItemProvider != null) acccessPointItemProvider.dispose();
