...
/**
 * This is the item provider adapter for a {@link NetworkArchitecture.FirmwareElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FirmwareElementItemProvider 
	 ...
	 * @generated
	 */
	public FirmwareElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((FirmwareElement)object).getModel();
		return label == null || label.length() == 0 ?
			getString("_UI_FirmwareElement_type") :
			getString("_UI_FirmwareElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FirmwareElement.class)) {
