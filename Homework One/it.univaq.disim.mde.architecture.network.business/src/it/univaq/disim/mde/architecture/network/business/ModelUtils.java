...
public class ModelUtils {
	...
	public static Network createNetworkDipenditiCoppito() {
		...
		AcccessPoint acccessPointC1Piano1 = NetworkArchitectureFactory.eINSTANCE.createAcccessPoint();
		acccessPointC1Piano1.setInternalIpAddress("170.20.0.4");
		acccessPointC1Piano1.setMaxClientSupport(300);
		acccessPointC1Piano1.setModel("Catalyst 9100 Access Points");
		acccessPointC1Piano1.setName("Edificio C1 piano 1");
		acccessPointC1Piano1.setOperatingSystem("Cisco IoS");
		acccessPointC1Piano1.setOsVersion("1.200.125b");
		acccessPointC1Piano1.setPortNumber(1);
		acccessPointC1Piano1.setVlan(vlanDefault);
		acccessPointC1Piano1.getWifis().add(wifiUnivaq24);
		acccessPointC1Piano1.getWifis().add(wifiUnivaq5);
		acccessPointC1Piano1.getWifis().add(wifiEduroam24);
		acccessPointC1Piano1.getWifis().add(wifiEduroam5);

		switchL3C1Piano1.getStaticRoute().add(staticRouteC1);
		switchL3C1Piano1.getAccessPoints().add(acccessPointC1Piano1);
		...
		AcccessPoint acccessPointC1Piano2 = NetworkArchitectureFactory.eINSTANCE.createAcccessPoint();
		acccessPointC1Piano2.setInternalIpAddress("170.20.0.4");
		acccessPointC1Piano2.setMaxClientSupport(300);
		acccessPointC1Piano2.setModel("Catalyst 9100 Access Points");
		acccessPointC1Piano2.setName("Edificio C1 piano 1");
		acccessPointC1Piano2.setOperatingSystem("Cisco IoS");
		acccessPointC1Piano2.setOsVersion("1.200.125b");
		acccessPointC1Piano2.setPortNumber(1);
		acccessPointC1Piano2.setVlan(vlanDefault);
		acccessPointC1Piano2.getWifis().add(wifiUnivaq24);
		acccessPointC1Piano2.getWifis().add(wifiUnivaq5);
		acccessPointC1Piano2.getWifis().add(wifiEduroam24);
		acccessPointC1Piano2.getWifis().add(wifiEduroam5);

		switchL3C1Piano2.getSwitchL2().add(switchL2);
		switchL3C1Piano2.getAccessPoints().add(acccessPointC1Piano2);
	...
	public static Network createNetworkHome() {
		...
		AcccessPoint acccessPoint = NetworkArchitectureFactory.eINSTANCE.createAcccessPoint();
		acccessPoint.setInternalIpAddress("192.168.0.1");
		acccessPoint.setMaxClientSupport(300);
		acccessPoint.setModel("FRITZ!Box 5690 Pro");
		acccessPoint.setName("Home");
		acccessPoint.setOperatingSystem("FRITZ!OS");
		acccessPoint.setOsVersion("7.90");
		acccessPoint.setPortNumber(1);
		acccessPoint.setVlan(vlanDefault);
		acccessPoint.getWifis().add(wifiHome24);
		acccessPoint.getWifis().add(wifiHome5);
		
		switchL3.getAccessPoints().add(acccessPoint);
