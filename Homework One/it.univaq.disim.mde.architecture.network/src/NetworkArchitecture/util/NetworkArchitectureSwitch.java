...
public class NetworkArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NetworkArchitecturePackage.ACCCESS_POINT: {
				AcccessPoint acccessPoint = (AcccessPoint)theEObject;
				T result = caseAcccessPoint(acccessPoint);
				if (result == null) result = caseInternalIpAddressElement(acccessPoint);
				if (result == null) result = caseNamedElement(acccessPoint);
				if (result == null) result = caseFirmwareElement(acccessPoint);
				if (result == null) result = casePortNumberElement(acccessPoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Acccess Point</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Acccess Point</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAcccessPoint(AcccessPoint object) {
		return null;
	}
