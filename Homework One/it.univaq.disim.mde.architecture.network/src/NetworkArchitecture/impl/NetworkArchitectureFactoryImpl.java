...
public class NetworkArchitectureFactoryImpl extends EFactoryImpl implements NetworkArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case NetworkArchitecturePackage.ACCCESS_POINT: return createAcccessPoint();
	 ...
	 */
	@Override
	public AcccessPoint createAcccessPoint() {
		AcccessPointImpl acccessPoint = new AcccessPointImpl();
		return acccessPoint;
	}
