...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Acccess Point</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getName <em>Name</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getModel <em>Model</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getOsVersion <em>Os Version</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getOperatingSystem <em>Operating System</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getPortNumber <em>Port Number</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getMaxClientSupport <em>Max Client Support</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getWifis <em>Wifis</em>}</li>
 *   <li>{@link NetworkArchitecture.impl.AcccessPointImpl#getVlan <em>Vlan</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AcccessPointImpl extends InternalIpAddressElementImpl implements AcccessPoint {
	/**
	...
	protected EClass eStaticClass() {
		return NetworkArchitecturePackage.Literals.ACCCESS_POINT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__NAME, oldName, name));
	}
	...
	public void setModel(String newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__MODEL, oldModel, model));
	}
	...
	public void setOsVersion(String newOsVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__OS_VERSION, oldOsVersion, osVersion));
	}
	...
	public void setOperatingSystem(String newOperatingSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__OPERATING_SYSTEM, oldOperatingSystem, operatingSystem));
	}
	...
	public void setPortNumber(int newPortNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__PORT_NUMBER, oldPortNumber, portNumber));
	}
	...
	public void setMaxClientSupport(int newMaxClientSupport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__MAX_CLIENT_SUPPORT, oldMaxClientSupport, maxClientSupport));
	}
	...
	public EList<Wifi> getWifis() {
		if (wifis == null) {
			wifis = new EObjectResolvingEList<Wifi>(Wifi.class, this, NetworkArchitecturePackage.ACCCESS_POINT__WIFIS);
		}
		return wifis;
	}
	...
	public VLAN getVlan() {
		if (vlan != null && vlan.eIsProxy()) {
			...
			if (vlan != oldVlan) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NetworkArchitecturePackage.ACCCESS_POINT__VLAN, oldVlan, vlan));
			}
		}
		return vlan;
	}
	...
	public void setVlan(VLAN newVlan) {
		...
		vlan = newVlan;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkArchitecturePackage.ACCCESS_POINT__VLAN, oldVlan, vlan));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NetworkArchitecturePackage.ACCCESS_POINT__WIFIS:
				return getWifis();
			case NetworkArchitecturePackage.ACCCESS_POINT__VLAN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case NetworkArchitecturePackage.ACCCESS_POINT__NAME: return NetworkArchitecturePackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == FirmwareElement.class) {
			switch (derivedFeatureID) {
				case NetworkArchitecturePackage.ACCCESS_POINT__MODEL: return NetworkArchitecturePackage.FIRMWARE_ELEMENT__MODEL;
				case NetworkArchitecturePackage.ACCCESS_POINT__OS_VERSION: return NetworkArchitecturePackage.FIRMWARE_ELEMENT__OS_VERSION;
				case NetworkArchitecturePackage.ACCCESS_POINT__OPERATING_SYSTEM: return NetworkArchitecturePackage.FIRMWARE_ELEMENT__OPERATING_SYSTEM;
				default: return -1;
			}
		}
		if (baseClass == PortNumberElement.class) {
			switch (derivedFeatureID) {
				case NetworkArchitecturePackage.ACCCESS_POINT__PORT_NUMBER: return NetworkArchitecturePackage.PORT_NUMBER_ELEMENT__PORT_NUMBER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case NetworkArchitecturePackage.NAMED_ELEMENT__NAME: return NetworkArchitecturePackage.ACCCESS_POINT__NAME;
				default: return -1;
			}
		}
		if (baseClass == FirmwareElement.class) {
			switch (baseFeatureID) {
				case NetworkArchitecturePackage.FIRMWARE_ELEMENT__MODEL: return NetworkArchitecturePackage.ACCCESS_POINT__MODEL;
				case NetworkArchitecturePackage.FIRMWARE_ELEMENT__OS_VERSION: return NetworkArchitecturePackage.ACCCESS_POINT__OS_VERSION;
				case NetworkArchitecturePackage.FIRMWARE_ELEMENT__OPERATING_SYSTEM: return NetworkArchitecturePackage.ACCCESS_POINT__OPERATING_SYSTEM;
				default: return -1;
			}
		}
		if (baseClass == PortNumberElement.class) {
			switch (baseFeatureID) {
				case NetworkArchitecturePackage.PORT_NUMBER_ELEMENT__PORT_NUMBER: return NetworkArchitecturePackage.ACCCESS_POINT__PORT_NUMBER;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == PortNumberElement.class) {
			switch (baseOperationID) {
				case NetworkArchitecturePackage.PORT_NUMBER_ELEMENT___IS_VALID_LAN_PORT_NUMBER: return NetworkArchitecturePackage.ACCCESS_POINT___IS_VALID_LAN_PORT_NUMBER;
				case NetworkArchitecturePackage.PORT_NUMBER_ELEMENT___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP: return NetworkArchitecturePackage.ACCCESS_POINT___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case NetworkArchitecturePackage.ACCCESS_POINT___IS_VALID_LAN_PORT_NUMBER:
				return isValidLanPortNumber();
			case NetworkArchitecturePackage.ACCCESS_POINT___VALID_LAN_PORT_NUMBER__DIAGNOSTICCHAIN_MAP:
